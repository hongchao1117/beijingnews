...
import com.hongchao.menudetailpager.tabdetailpager.TopicDetailPager;
...
public class TopicMenuDetailPager extends MenuDetailBasePager {
    ...
    public void initData() {
        ...
        tableLayout.addOnTabSelectedListener(new TopicMenuDetailPager.MyBaseOnTabSelectedListener());
    ...
    class MyNewsMenuDetailPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            TopicDetailPager topicDetailPager = tabDetailPagers.get(position);
